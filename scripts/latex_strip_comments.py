...
2. For \makeatletter \makeatother block, Preserve "%" if it is actually a
   comment, and trim the line while preserve the "\n" at the end of the line. 
   That is because remove the % some time will result in compilation failure.
"""
...
#             ('verbatim', 'exclusive'))
    ...
    def t_linecomment_ENDCOMMENT(t):
        ...
        # Newline at the end of a line comment is preserved
        return t
